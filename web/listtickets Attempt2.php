...
<?php
	...
	if(!$stmt->prepare($query)) {
		...
		$qty = "<br><input type='number' id='number' value='1' id='qty' size='1' name='testtest'>";
		...
		while($stmt->fetch()) {
			if($inventory=="0") {
				...
				<br><br><br><b>$pname</b><br>\$$cost<br>$qty 'Sold Out'<br> </p><br><br><br><br><br>";
			} else {
				echo "<br><a href=\"images/tickets/$image\"><img src=\"images/tickets/$image\" alt=\"Ticket Image\" style=\"float:left\"></a>
				<br><br><br><b>$pname</b><br>\$$cost<br>$qty <span><a href=\"addcart.jsp?pid=$pid&pname=$pname&qty=$_GET[testtest];\">
				Add to Cart</a></span><br> </p><br><br><br><br><br>";
			}
		echo "";			
	}
